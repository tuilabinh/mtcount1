...
(function($) {
	$.fn.iconPicker = function( options ) {
	  ...
	  for (var i in icons) {
	  	...
	  	if(options[0] == 'eleganticons'){
	  		...
	  		if(options[0] == "icon"){
	  			$classess = "wpmega-icommon";
	  		}else{
	  			$classess = "wpmega-other";
	  		}
	...
	function createPopup($button) {
		...
		$control.html('<p>Select Font: <select><option value="dashicons">Dashicons</option><option value="linecon">Linecons</option><option value="fa">Font Awesome 4.7.0</option><optgroup label="Font Awesome 5.x"><option value="fab">Brands</option><option value="far">Regular</option><option value="fas">Solid</option></optgroup><option value="genericon">Genericons</option><option value="icon">Icomoon</option><option value="lnr">Linearicons</option><option value="ti">Themify</option></select></p>'+
