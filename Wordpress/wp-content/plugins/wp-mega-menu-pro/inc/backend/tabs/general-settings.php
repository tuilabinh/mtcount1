                ...
                <table>
                    ...
                    <tr>
                        <td class='apmega-name'>
                           ...
                           <p class="description"><?php _e('Choose default animation type for menu label such as Hot!,New!.Default is set as None which will disable animation. This field is necessary to set for overall menu label animation.',APMM_PRO_TD);?></p>
                        </td>
                        <td class='apmega-value'>
