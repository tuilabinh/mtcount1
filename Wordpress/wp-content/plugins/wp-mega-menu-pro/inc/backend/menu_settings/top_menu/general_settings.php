...
$hide_icon_mobile = (isset($wpmmenu_item_meta['general_settings']['hide_icon_mobile']) && $wpmmenu_item_meta['general_settings']['hide_icon_mobile'] == 'enabled')?'enabled':'';
  ...
  <div class="settings_content">
      <div class="settings_title"><h4><?php _e('Menu Item Settings',APMM_PRO_TD);?></h4></div>
  	   <table class="widefat">
		  ...
		  <tr>
			<td class="wpmm_meta_table"><label for="hide_icon_mobile"><?php _e("Hide Menu Icon On Mobile?", APMM_PRO_TD) ?></label></td>
			  <td> 
			  <div class="wpmm-switch">
			      <input type='checkbox' class='wpmm_menu_settingss' id="hide_icon_mobile"
			      name='wpmm_settings[general_settings][hide_icon_mobile]' value='enabled' <?php echo checked($hide_icon_mobile,'enabled', 'disabled' ); ?>/>
			   <label for="hide_icon_mobile"></label>
               </div>
                 <p class="description"><?php _e("In order to hide menu icon only on mobile then you need to enable this option.", APMM_PRO_TD); ?></p>
			  </td>
		  </tr>
