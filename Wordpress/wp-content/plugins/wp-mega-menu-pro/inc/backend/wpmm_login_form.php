...
<form id="wpmm_login" class="ajax-auth" action="login" method="post">
    <?php /*<!-- <h3>New to site? <input type="button" id="wpmm_pop_signup" value="Create an Account"/></h3>
    <hr /> --> */ ?>
   ...
   <?php /* <!-- <input type="button" class="text-link" href="<?php echo wp_lostpassword_url(); ?>">Lost password?</a> --> */?>
...
<form id="wpmm_register" class="ajax-auth"  action="register" method="post">
	<?php /*<!-- <h3>Already have an account? 
