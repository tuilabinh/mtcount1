...
<tbody>
  	<tr>
		<td>
			<label><?php _e('Background',APMM_PRO_TD);?>
				<p class="description left_note"><?php _e('Enable and then set custom background color for mega menu wrapper. You can even set custom transparent background color.',APMM_PRO_TD);?></p>
			</label>
		</td> 
		<td>
           <div class="wpmmpro-box-opt">
			  	 <table>
                     <tr>
			  	 		<td width="140"><label for="megamenu_bg"><?php _e('Enable',APMM_PRO_TD);?></label></td>
					      ...
					      class="apmm_enable_menu_background" name="apmm_theme[megamenu_bar][enable_megamenu_background]">
			  	    ...
			  	    <tr>
			  	 	    ...
			  	 	    <td><input type="text" value="<?php echo (!isset($megamenu_menu_background_from))?'':esc_attr($megamenu_menu_background_from);?>" data-alpha="true" name="apmm_theme[megamenu_bar][menu_background_from]" class="apmm-color-picker" /></td>
			  	    </tr>
			  	 </table>
			  	</div>
		   </td>
	...
	<tr>
		<td>
			<label><?php _e('Define Custom Width',APMM_PRO_TD);?></label>
			<p class="description left_note"><?php _e('Set Mega Menu Panel width in px.',APMM_PRO_TD);?></p>
		</td> 
		<td>
		 <input type="text" value="<?php echo (!isset($megamenu_width))?'':esc_attr($megamenu_width);?>" placeholder="<?php _e('Eg., 600px or 60%',APMM_PRO_TD);?>" 
			  ...
			  <div class="wpmmpro-box-opt">
			  	 <table>
                     <tr>
			  	 	    ...
			  	 	    <td><input type="text" value="<?php echo (!isset($megamenu_border_color))?'':esc_attr($megamenu_border_color);?>" name="apmm_theme[megamenu_bar][border_color]" 
				class="apmm-color-picker"/>
		                </td>
			  	    </tr>
			  	    <tr>
			  	 		<td width="140"><span><?php _e('Radius',APMM_PRO_TD);?></span></td>
			  	 	    <td><input type="text" value="<?php echo (!isset($megamenu_border_radius))?'':esc_attr($megamenu_border_radius);?>" name="apmm_theme[megamenu_bar][border_radius]" class="apmega-menu_bar_padding"/></td>
			  	    </tr>
			  	 </table>
			  	</div>
		</td>
