...
<tbody>
    <tr>
		<td>
			<label for="flyout_bg"><?php _e('Enable Background & Set Color',APMM_PRO_TD);?></span>
			<p class="description left_note"><?php _e('Enable background color at first and then select color for flyout menu.',APMM_PRO_TD);?></p>
		</td> 
		<td>
		...
		<br/>
	     <div class="wpmmpro-box-opt">
		  	 <table>
		  	 	<tr>
		  	 		<td width="140"><span><?php _e('Background Current Color',APMM_PRO_TD);?></span></td>
		  	 	    <td><input type="text" value="<?php echo isset( $flyout_menu_bgcurrentcolor ) ? esc_attr($flyout_menu_bgcurrentcolor) : ''; ?>" data-alpha="true" name="apmm_theme[flyout][menu_bgcurrentcolor]" class="apmm-color-picker" /></td>
		  	    </tr>
		  	    <tr>
		  	 		<td width="140"><span><?php _e('Background Hover Color',APMM_PRO_TD);?></span></td>
		  	 	    <td><input type="text" value="<?php echo isset( $flyout_menu_bg_hovercolor ) ? esc_attr( $flyout_menu_bg_hovercolor ) : ''; ?>" data-alpha="true" name="apmm_theme[flyout][menu_bg_hovercolor]" class="apmm-color-picker"/></td>
		  	    </tr>
		  	 </table>
		  </div>
		</td>
	...
	<tr>
		...
		<td>
			<div class="wpmmpro-box-opt">
		  	 <table>
		  	 	<tr>
		  	 		<td width="140"><span><span><?php _e('Color',APMM_PRO_TD);?></span></span></td>
		  	 	    <td><input type="text" name="apmm_theme[flyout][font_color]" 
		class="apmega-menu_bar_padding apmm-color-picker" value="<?php echo isset( $flyout_font_color ) ? esc_attr( $flyout_font_color ) : ''; ?>"/></td>
		  	    </tr>
		  	    <tr>
		  	 		<td width="140"><span><?php _e('Color [Hover]',APMM_PRO_TD);?></span></td>
		  	 	    <td><input type="text" name="apmm_theme[flyout][font_hover_color]" 
		class="apmega-menu_bar_padding apmm-color-picker" value="<?php echo isset( $flyout_font_hover_color ) ? esc_attr( $flyout_font_hover_color ) : ''; ?>"/></td>
		  	    </tr>
		  	    <tr>
		  	 		<td width="140"><span><?php _e('Size',APMM_PRO_TD);?></span></td>
		  	 	    <td><input type="text" value="<?php echo isset( $flyout_font_size ) ? esc_attr( $flyout_font_size ) : ''; ?>" name="apmm_theme[flyout][font_size]" class="apmega-menu_bar_padding" placeholder="0px"/></td>
		  	    </tr>
		  	 </table>
