...
<tbody>
	...
	<tr>
		<td>
			...
			<p class="description"><?php _e('Enable shadow and set customn color to mega menu and flyout menus.',APMM_PRO_TD);?></p>
		</td> 
		<td>
            <div class="wpmmpro-box-opt">
		  	 <table>
		  	 	<tr>
		  	 		<td width="140"><label for="enable_shadow"><?php _e('Enable',APMM_PRO_TD);?></label></td>
		  	    ...
		  	    <tr>
		  	 	    ...
		  	 	    <td><input type="text" value="<?php echo (!isset($shadow_color))?'':esc_attr($shadow_color);?>" name="apmm_theme[general][shadow_color]" class="apmm-color-picker" /></td>
		  	    </tr>
		  	 </table>
		  </div>
		</td>
