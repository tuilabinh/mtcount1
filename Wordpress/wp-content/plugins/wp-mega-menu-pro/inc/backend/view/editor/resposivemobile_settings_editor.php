...
<tr>
	...
	<td>
		<div class="wpmmpro-box-opt">
			  	 <table>
                     <tr>
			  	 		<td width="140"><label for="bgcolor_enable"><?php _e('Enable',APMM_PRO_TD);?></label></td>
			  	 	    <td>  
			  	    ...
			  	    <tr>
			  	 	    ...
			  	 	    <td><input type="text" value="<?php echo (!isset($togglebar_background_from))?'':esc_attr($togglebar_background_from);?>" data-alpha="true" 
			name="apmm_theme[mobile_settings][togglebar_background_from]" 
			class="apmm-color-picker" /></td>
			  	    </tr>
			  	 </table>
          </div>
	</td>
...
<tr>
	<td>
		<label><?php _e('Menu Toggle Icon Font',APMM_PRO_TD);?></label>
	...
	<td>
		<div class="wpmmpro-box-opt">
			  	 <table>
                     <tr>
			  	 		<td width="140"><span><?php _e('Icon Color',APMM_PRO_TD);?></span></td>
			  	 	    <td>  
	       ...
	       class="apmega-menu_bar_padding apmm-color-picker" value="<?php echo (!isset($togglebar_icon_color))?'':esc_attr($togglebar_icon_color);?>"/>
			  	    ...
			  	    <tr>
			  	 		<td width="140"><span><?php _e('Text Color',APMM_PRO_TD);?></span></td>
			  	 	    <td><input type="text" name="apmm_theme[mobile_settings][text_color]" 
	       class="apmega-menu_bar_padding apmm-color-picker" value="<?php echo (!isset($togglebar_text_color))?'':esc_attr($togglebar_text_color);?>"/></td>
			  	    </tr>
			  	 </table>
          </div>
	</td>
