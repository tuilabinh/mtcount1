...
<tbody>
	<tr>
	<td>
		<label><?php _e('Menu Background Color',APMM_PRO_TD);?>
		<p class="description left_note"><?php _e('Enable and Set custom background color for menu bar.',APMM_PRO_TD);?></p>
		</label>
	</td> 
	<td>
        <div class="wpmmpro-box-opt">
		  	 <table>
		  	 	<tr>
		  	 		<td width="140"><label for="menu_bg"><?php _e('Enable',APMM_PRO_TD);?></label></td>
		  	 	    <td> <div class="wpmm-switch">
					    <input type="checkbox" value="1" <?php echo (isset($enable_menu_background) && $enable_menu_background == 0)?'':'checked';?>  id="menu_bg" class="apmm_enable_menu_background" name="apmm_theme[menu_bar][enable_menu_background]"/>
					    <label for="menu_bg"></label>
				       </div></td>
		  	    </tr>
		  	    <tr>
		  	 		<td width="140"><span><?php _e('Background Color',APMM_PRO_TD);?></span></td>
		  	 	    <td><input type="text" value="<?php echo (!isset($menu_background_from))?'':esc_attr($menu_background_from);?>" data-alpha="true" name="apmm_theme[menu_bar][menu_background_from]" class="apmm-color-picker" /></td>
		  	    </tr>
		  	 </table>
		  </div>
	</td>
	...
	<tr>
		<td>
			<label><?php _e('All Menu Items Font',APMM_PRO_TD);?></label>
		</td>
		<td>
			<div class="wpmmpro-box-opt">
		  	 <table>
		  	 	<tr>
		  	 		<td width="140"><label for="menu_bg"><?php _e('Font Color',APMM_PRO_TD);?></label></td>
		  	 	    <td> <input type="text" value="<?php echo (!isset($font_color))?'':esc_attr($font_color);?>" name="apmm_theme[menu_bar][font_color]" class="apmm-color-picker" /></td>
		  	    </tr>
		  	    <tr>
		  	 		<td width="140"><span><?php _e('Font Hover Color',APMM_PRO_TD);?></span></td>
		  	 	    <td><input type="text" value="<?php echo (!isset($font_hover_color))?'':esc_attr($font_hover_color);?>" 
      name="apmm_theme[menu_bar][font_hover_color]" class="apmm-color-picker" /></td>
		  	    </tr>
		  	 </table>
		  </div>
		</td>
