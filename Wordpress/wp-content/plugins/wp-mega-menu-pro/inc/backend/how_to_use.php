...
<div class="col-sm-9">
   <h3><?php _e('How to Use',APMM_PRO_TD);?></h3>
      ...
      <a href="https://accesspressthemes.com/documentation/responsive-mega-menu-for-wordpress-wp-mega-menu-pro/" target="_blank"><?php _e('View Documentation',APMM_PRO_TD);?></a></p>
       <p><?php _e('For more detail documentation of our plugin, please visit below link',APMM_PRO_TD);?>
      <a href=" https://demo.accesspressthemes.com/wordpress-plugins/wp-mega-menu-pro/docs/" target="_blank"><?php _e('Documentation With Video Tutorials',APMM_PRO_TD);?></a>
       </p>
